...
public class PlayerUI_S : MonoBehaviour
{
    ...
    private PlayerManager_S target;
    ...
    void Update()
    {
        ...
        {
            if(target.IamAServer != null && target.IamAServer.IAmAServer)
            {
                playerNameText.color = Color.red;
            }
            else if (playerNameText.color != Color.white)
            {
    ...
    public void SetTarget(PlayerManager_S _target)
    {
        if (_target == null)
        {
